...
const createTerminal = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield terminal_model_1.Terminal.create(payload);
    return result;
});
const getAllTerminal = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleTerminal = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateTerminal = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield terminal_model_1.Terminal.findOne({ _id: id });
    if (!isExist) {
        throw new apiError_1.default(http_status_1.default.NOT_FOUND, `Terminal not found`);
    }
    const result = yield terminal_model_1.Terminal.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteTerminal = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield terminal_model_1.Terminal.findOne({ _id: id });
    if (!isExist) {
        throw new apiError_1.default(http_status_1.default.NOT_FOUND, `Terminal not found`);
    }
    const result = yield terminal_model_1.Terminal.findOneAndDelete({ _id: id }, { new: true });
    return result;
});
const createTerminalIntoEbl365 = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    let newTerminal;
    ...
    try {
        ...
        const createdTerminal = yield terminal_model_1.Terminal.create([payload], { session });
        newTerminal = createdTerminal[0];
        console.log('newTerminal', newTerminal);
        const res = yield ebl365_model_1.Ebl365.updateOne({ _id: payload.terminal365 }, {
            $push: {
