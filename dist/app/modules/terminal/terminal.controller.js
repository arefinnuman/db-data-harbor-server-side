...
const createTerminal = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield terminal_service_1.TerminalService.createTerminal(data);
...
const createTerminalIntoEbl365 = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = __rest(req.body, []);
    const result = yield terminal_service_1.TerminalService.createTerminalIntoEbl365(data);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: `Terminal created successfully`,
