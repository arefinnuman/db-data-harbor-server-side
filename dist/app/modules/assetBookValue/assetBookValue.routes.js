...
router.get('/terminal/:id', (0, authorization_1.default)(user_constant_1.ENUM_USER_ROLE.SUPER_ADMIN, user_constant_1.ENUM_USER_ROLE.ADMIN, user_constant_1.ENUM_USER_ROLE.MAKER, user_constant_1.ENUM_USER_ROLE.VIEWER), assetBookValue_controller_1.AssetBookValueController.getAssetValueByTerminalId);
router.get('/unassigned-terminals', (0, authorization_1.default)(user_constant_1.ENUM_USER_ROLE.SUPER_ADMIN, user_constant_1.ENUM_USER_ROLE.ADMIN), assetBookValue_controller_1.AssetBookValueController.unAssignedTerminalsInAssetBookValue);
