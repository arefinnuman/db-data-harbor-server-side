...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const refreshToken = jwtHelpers_1.jwtHelpers.createToken({ userId, employeeId, role, needsPasswordChange, approved, team, fullName }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    return {
        accessToken,
        refreshToken,
        needsPasswordChange,
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.User.isUserExist(employeeId);
    if (!isUserExist) {
        throw new apiError_1.default(http_status_1.default.NOT_FOUND, 'user does not exist');
    }
