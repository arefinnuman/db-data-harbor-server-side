...
const createEbl365 = (0, catchAsync_1.default)((req, res) =>
...
const getAllEbl365 = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      ebl365_constant_1.Ebl365FilterableFields,
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields,
    );
    const result = yield ebl365_service_1.Ebl365Service.getAllEbl365(
      filters,
      paginationOptions,
    );
    (0, sendResponse_1.default)(res, {
...
const getSingleEbl365 = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateEbl365 = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const data = req.body;
    const result = yield ebl365_service_1.Ebl365Service.updateEbl365(id, data);
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const deleteEbl365 = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
