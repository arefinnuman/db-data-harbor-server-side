...
const updateToSuperAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const employeeId = req.params.employeeId;
    const result = yield user_service_1.UserService.updateToSuperAdmin(employeeId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: 'User updated successfully !',
...
const updateToAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const employeeId = req.params.employeeId;
    const result = yield user_service_1.UserService.updateToAdmin(employeeId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: 'User updated successfully !',
...
const updateToMaker = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const employeeId = req.params.employeeId;
    const result = yield user_service_1.UserService.updateToMaker(employeeId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: 'User updated successfully !',
...
const updateToViewer = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const employeeId = req.params.employeeId;
    const result = yield user_service_1.UserService.updateToViewer(employeeId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: 'User updated successfully !',
