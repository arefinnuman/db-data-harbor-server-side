...
const createTerminal = (payload, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield ebl365_model_1.Ebl365.updateOne({ _id: payload.ebl365 }, {
            $push: {
...
const deleteTerminal = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        session.startTransaction();
        const terminalToDelete = yield terminal_model_1.Terminal.findOne({
            _id: id,
        }).session(session);
        if (!terminalToDelete) {
            throw new apiError_1.default(http_status_1.default.NOT_FOUND, `Terminal not found`);
        }
        const result = yield terminal_model_1.Terminal.findByIdAndDelete(id).session(session);
        yield ebl365_model_1.Ebl365.updateOne({ machines: id }, {
            $pull: {
                machines: id,
            },
        }, { session });
