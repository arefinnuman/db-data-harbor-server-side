...
const createEbl365 = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const boothDevicesArray = Object.keys(machineTypeCounts).map(type => `${machineTypeCounts[type]} ${type}`);
    let boothDevicesStr = '';
    ...
    yield ebl365_model_1.Ebl365.findByIdAndUpdate(result._id, { boothDevices: boothDevicesStr });
    return result;
});
...
const getSingleEbl365 = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield ebl365_model_1.Ebl365.findById(id).populate('machines');
    if (!result) {
        throw new apiError_1.default(http_status_1.default.NOT_FOUND, `Ebl365 not found`);
    }
    return result;
...
const updateEbl365 = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield ebl365_model_1.Ebl365.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    }).populate('machines');
    return result;
});
const deleteEbl365 = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield ebl365_model_1.Ebl365.findOneAndDelete({ _id: id }, { new: true });
    return result;
});
